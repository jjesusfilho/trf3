# Getting help with trf3

Thanks for using trf3. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/trf3/issues) to make sure the 
